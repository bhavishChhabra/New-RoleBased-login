    ...
    private void signUp() {
        if(emailsignup.getText().toString().isEmpty()){
            ...
            if (emailsignup.getText().toString().equals(emailID)) {
                ...
                Toast.makeText(SignUp.this, R.string.newEmail, Toast.LENGTH_SHORT).show();
            } else {
                                ...
                                (this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(SignUp.this, R.string.SuccessSign,
                                    ...
                                    firebaseDatabase.child ("Username").setValue (uname.getText ().toString ());
